...
/***/ function(module, exports, __webpack_require__) {
	...
	var Screen = __webpack_require__(4);
	var Color = __webpack_require__(12);
	var Vector = __webpack_require__(3);
	
	// Actor Stuff
	var Actor = __webpack_require__(7);
	var Enemy = __webpack_require__(17);
	var PlayerController = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Input.keyDownHandler = function (e) {
	  ...
	  if (Input.keyDownListeners[e.keyCode]) {
	    Input.keyDownListeners[e.keyCode].forEach(function (listener) {
	      listener();
	    });
	  }
	};
	...
	Input.keyUpHandler = function (e) {
	  ...
	  var keys = Object.keys(Input.keyUpListeners);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	Vector.DIRS = [new Vector(1, 1), new Vector(0, 0), new Vector(0, 1), new Vector(1, 0), new Vector(-1, -1), new Vector(-1, 1), new Vector(1, -1), new Vector(0, -1), new Vector(-1, 0)];
	
	Vector.prototype.toScreenPos = function () {
	  var screenX = this.x + Screen.WIDTH / 2;
	  var screenY = Screen.HEIGHT / 2 - this.y;
	
	  return new Vector(screenX, screenY);
	};
	
	Vector.prototype.toWorldPos = function () {
	  var worldX = this.x - Screen.WIDTH / 2;
	  var worldY = Screen.HEIGHT / 2 - this.y;
	...
	Vector.randDir = function () {
	  var vec = Vector.DIRS[Math.floor(Math.random() * Vector.DIRS.length)];
	
	  return vec;
	};
	
	Vector.randomVelocity = function () {
	  var vec = Vector.randDir(1);
...
/***/ function(module, exports) {
	...
	module.exports = {
	  WIDTH: 720,
	  HEIGHT: 480,
	  rectOutOfBounds: function rectOutOfBounds(rect) {
	    ...
	    var rectBorderRight = rect.left + rect.width;
	    var rectBorderLeft = rect.left;
	
	    var rectBorderTop = rect.top;
	    var rectBorderBottom = rect.top + rect.height;
	
	    var outOfBoundsLeft = rectBorderLeft < 0;
	    var outOfBoundsRight = rectBorderRight > this.WIDTH;
	    var outOfBoundsTop = rectBorderTop < 0;
	    var outOfBoundsBottom = rectBorderBottom > this.HEIGHT;
	
	    return outOfBoundsLeft || outOfBoundsTop || outOfBoundsRight || outOfBoundsBottom;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rect = __webpack_require__(8);
	var Collider = __webpack_require__(9);
	var Controller = __webpack_require__(11);
	...
	function Actor(pos, team, color) {
	  ...
	  var rect = new Rect(this.transform.position.x, this.transform.position.y, 50, 50);
	...
	Actor.prototype.getComponent = function (componentType) {
	  ...
	  if (this.components[componentType]) {
	    ...
	    var componentClasses = Object.keys(this.components);
	
	    var target = void 0;
	    componentClasses.forEach(function (compClass) {
	      if (_this.components[compClass].constructor.super === componentType) {
	        target = _this.components[compClass];
	      }
	    });
	...
	Actor.prototype.isColliding = function (actor) {
	  ...
	  if (collider) {
	    var otherCollider = actor.getComponent(Collider);
	...
	Actor.prototype.destroy = function () {
	  ...
	  var index = Actor.all.indexOf(this);
...
/***/ function(module, exports) {
	...
	Rect.prototype.isColliding = function (rect2) {
	  return this.left < rect2.left + rect2.width && this.left + this.width > rect2.left && this.top < rect2.top + rect2.height && this.height + this.top > rect2.top;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Collider.prototype.outOfBounds = function () {
	  var actorScreenPos = this.actor.transform.position.toScreenPos();
	
	  var rect = new Rect(actorScreenPos.x, actorScreenPos.y, this.actor.col.width, this.actor.col.height);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Controller.prototype.inputOutOfBounds = function (input) {
	  ...
	  var rect = new Rect(actorScreenPos.x + input.x, actorScreenPos.y + input.y, this.actor.col.width, this.actor.col.height);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bullet = __webpack_require__(19);
	...
	PlayerController.prototype.fire = function () {
	  var position = new Vector(this.actor.transform.position.x, this.actor.transform.position.y + 10);
	
	  var b = new Bullet(position, this.team, Color.white, new Vector(0, 1));
	
	  b.spawn();
	};
	
	PlayerController.prototype.getMoveInput = function () {
	  var left = Input.getKey(BUTTONS["left"]);
	  ...
	  var right = Input.getKey(BUTTONS["right"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Renderer.prototype.render = function (ctx) {
	  ...
	  var newPos = this.actor.transform.position.toScreenPos();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KamikazeController = __webpack_require__(18);
	var Transform = __webpack_require__(10);
	var Renderer = __webpack_require__(15);
	var Collider = __webpack_require__(9);
	...
	Enemy.spawnRandomEnemy = function () {
	  var enemyVector = new Vector(Math.random() * (Screen.WIDTH - 50), 10).toWorldPos();
	
	  var enemy = new Enemy(enemyVector, 2, Color.red);
	
	  var size = Math.random() * 15 + 30;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Bullet.prototype.tick = function () {
	  ...
	  Actor.all.forEach(function (actor) {
	    if (actor.isColliding(_this)) {
	      console.log("wooooooooooooo");
	      if (actor.team !== _this.team) {
	        actor.destroy();
	        _this.destroy();
	      }
	    }
